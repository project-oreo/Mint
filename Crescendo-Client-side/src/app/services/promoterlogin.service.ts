...
export class PromoterloginService {
  ...
  login(email: string, password: string): void {
    ...
    this.httpClient.post('http://ec2-13-59-68-239.us-east-2.compute.amazonaws.com:8081/Crescendo/promoters/login', payload, {
      observe: 'response'
  ...
  promoterGigs() {
    this.httpClient.get(`http://ec2-13-59-68-239.us-east-2.compute.amazonaws.com:8081/Crescendo/promoters/gigs/${this.promoter.id}`, {
      observe: 'response'
  ...
  pullAllBands() {
    this.httpClient.get('http://ec2-13-59-68-239.us-east-2.compute.amazonaws.com:8081/Crescendo/promoters/allbands', {
      observe: 'response'
